...
public class IocHelper {
	...
	//TODO TCF 启动IOC/DI依赖注入容器，加载基准包及其子包中的所有类，基于反射给目标实例的目标属性注入属性值，基于反射调用目标实例的目标方法
									...
									if(StringUtils.isNotEmpty(fieldName))
									{
										...
										if(fieldMap!=null)
										{
											for(Map.Entry<String,Map<String,Object>> fieldEntry:fieldMap.entrySet())
											{
											    ...
											    //TODO TCF 需要注入的属性所在类simpleName必须和当前加载的类simpleName相同
	...
	public static boolean injectFieldFilter(Field field)
	{
		...
		{
			//TODO TCF ...自定义其他过滤条件过滤需要注入的属性
		}
		
		return result;
	}
	
	//TODO TCF 过滤需要调用的目标方法
