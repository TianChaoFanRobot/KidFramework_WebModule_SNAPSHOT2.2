...
/***
 * TODO TCF MVC控制器助手类
 * TODO TCF 初始化建立请求和处理之间的映射关系Map(Request -> Handle)
...
public class ControllerHelper {
	...
	//TODO TCF 加载使用KidController注解标注的MVC处理请求控制器，建立请求和处理之间的映射关系Map(Request -> Handle)
        ...
        if(controllerClassList!=null && controllerClassList.size()>0)
        {
        	for(Class<?> controllerClass:controllerClassList)
        	{
        		...
        		if(methods!=null && methods.length>0)
        		{
        			...
        			{
        				//TODO TCF 获取控制器处理方法上定义的KidAction注解
